...
_PS_EXTERN_CONST_TYPE(am_sign_mask, int32, static_cast<int32>(0x80000000L));
_PS_EXTERN_CONST_TYPE(am_inv_sign_mask, int32, static_cast<int32>(~0x80000000L));
_PS_EXTERN_CONST_TYPE(am_min_norm_pos, int32, 0x00800000);
_PS_EXTERN_CONST_TYPE(am_mant_mask, int32, static_cast<int32>(0x7f800000));
_PS_EXTERN_CONST_TYPE(am_inv_mant_mask, int32, static_cast<int32>(~0x7f800000));
