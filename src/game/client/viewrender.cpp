...
static void GetFogColorTransition(fogparams_t* pFogParams, float* pColorPrimary, float* pColorSecondary)
{
	...
	if (pFogParams->lerptime >= gpGlobals->curtime)
	{
		...
		float flPrimaryColorLerp[3] = { static_cast<float>(pFogParams->colorPrimaryLerpTo.GetR()), static_cast<float>(pFogParams->colorPrimaryLerpTo.GetG()), static_cast<float>(pFogParams->colorPrimaryLerpTo.GetB()) };
		float flSecondaryColorLerp[3] = { static_cast<float>(pFogParams->colorSecondaryLerpTo.GetR()), static_cast<float>(pFogParams->colorSecondaryLerpTo.GetG()), static_cast<float>(pFogParams->colorSecondaryLerpTo.GetB()) };
...
static void GetFogColor(fogparams_t* pFogParams, float* pColor)
{
	...
	{
		float flPrimaryColor[3] = { static_cast<float>(pFogParams->colorPrimary.GetR()), static_cast<float>(pFogParams->colorPrimary.GetG()), static_cast<float>(pFogParams->colorPrimary.GetB()) };
		float flSecondaryColor[3] = { static_cast<float>(pFogParams->colorSecondary.GetR()), static_cast<float>(pFogParams->colorSecondary.GetG()), static_cast<float>(pFogParams->colorSecondary.GetB()) };
