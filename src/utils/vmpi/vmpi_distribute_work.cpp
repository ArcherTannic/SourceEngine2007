...
{
	// Используем unsigned char для cPacketID, чтобы избежать преобразования
	unsigned char cPacketID[2] = { static_cast<unsigned char>(g_DSInfo.m_cPacketID), cSubpacketID };
